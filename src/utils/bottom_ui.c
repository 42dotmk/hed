...
void layout_compute(Layout *lo) {
    ...
    lo->content_rows = avail_rows; /* includes any panes like quickfix when integrated in layout */
    ...
    /* Command/message row sits directly below status bar; quickfix is part of content now */
