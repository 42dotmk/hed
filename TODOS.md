...
## [TODO] Virtual text
   might be something usefull as well, especially for suggestions

## [TODO] Autocomplete utilities
Extend the modals API, and provide this as plugins

## [TODO] Better API for the command mode
   Its not good at the moment, at all

## [TODO] Alternative to FZF
   Use local GUI for searching and filtering(more control for the UI).

## [TODO] Themes
   At the moment only one theme is supported, we should allow switching themes
